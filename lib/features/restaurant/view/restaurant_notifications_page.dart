        ...
        body: SafeArea(
          ...
          child: BlocConsumer<RestaurantCubit, RestaurantState>(
            listener: (context, state) {
              if (state is RestaurantNotificationsLoaded ||
                  state is RestaurantNotificationsRead ||
            ...
            builder: (context, state) {
              ...
              final loading =
                  data == null &&
                  (!initialLoadFinished ||
                      state is RestaurantNotificationsLoading);
              ...
              return CustomScrollView(
                ...
                slivers: [
                  const PinnedAppHeaderSliver(
                    height: 72,
                    child: _RestaurantNotificationsBar(),
                  ),
...
class _RestaurantNotificationsBar extends StatelessWidget {
  const _RestaurantNotificationsBar();
